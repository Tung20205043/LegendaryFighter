...
public class JoystickEditor : Editor
{
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(snapX, new GUIContent("Snap X", "Snap the horizontal input to a whole imgs."));
        EditorGUILayout.PropertyField(snapY, new GUIContent("Snap Y", "Snap the vertical input to a whole imgs."));
    }
