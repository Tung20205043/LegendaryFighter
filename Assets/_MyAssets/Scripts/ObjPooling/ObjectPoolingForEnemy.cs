...
public class ObjectPoolingForEnemy : ObjectPooling
{
    public static ObjectPoolingForEnemy Instance { get; private set; }
    ...
    private void Start() {
        SpecialUnityEvent.Instance.enemyDoTransform.AddListener(UpdatePoolingToSpawn);
    }
